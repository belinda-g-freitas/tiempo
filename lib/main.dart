...
import 'package:tiempo/app/modules/home.dart';
import 'package:tiempo/app/modules/onboarding.dart';
import 'package:tiempo/theme/theme.dart';
...
void main() async {
  ...
  const LinuxInitializationSettings initializationSettingsLinux = LinuxInitializationSettings(defaultActionName: 'Tiempo');
...
class _MyAppState extends State<MyApp> {
  ...
  void changeAmoledTheme(bool newAmoledTheme) => setState(() => amoledTheme = newAmoledTheme);

  void changeMarerialTheme(bool newMaterialColor) => setState(() => materialColor = newMaterialColor);

  void changeTimeRange(int newTimeRange) => setState(() => timeRange = newTimeRange);

  void changeTimeStart(String newTimeStart) => setState(() => timeStart = newTimeStart);
  ...
  void changeWidgetBackgroundColor(String newWidgetBackgroundColor) => setState(() => widgetBackgroundColor = newWidgetBackgroundColor);

  void changeWidgetTextColor(String newWidgetTextColor) => setState(() => widgetTextColor = newWidgetTextColor);
