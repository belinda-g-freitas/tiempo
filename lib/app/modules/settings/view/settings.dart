...
import 'package:tiempo/app/controller/controller.dart';
import 'package:tiempo/app/data/weather.dart';
import 'package:tiempo/app/modules/settings/widgets/setting_card.dart';
import 'package:tiempo/main.dart';
import 'package:tiempo/theme/theme_controller.dart';
import 'package:tiempo/utils/color_converter.dart';
      ...
      child: Column(
        ...
        children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text('appearance'.tr, style: context.textTheme.titleLarge?.copyWith(fontSize: 20)),
                            ),
                            SettingCard(
                              elevation: 4,
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 15),
                              child: Text('functions'.tr, style: context.textTheme.titleLarge?.copyWith(fontSize: 20)),
                            ),
                            SettingCard(
                              elevation: 4,
                                        ...
                                        return AlertDialog.adaptive(
                                          ...
                                          actions: [
                                            TextButton(
                                              ...
                                              child:
                                                  Text('cancel'.tr, style: context.theme.textTheme.titleMedium?.copyWith(color: Colors.blueAccent)),
                                            ),
                                            TextButton(
                                              onPressed: () {
                                              ...
                                              child: Text('settings'.tr, style: context.theme.textTheme.titleMedium?.copyWith(color: Colors.green)),
                                            ),
                                          ],
                                        );
                                      },
                            ...
                            SettingCard(
                              ...
                              infoWidget: _TextInfo(
                                info: settings.timeformat == '12'
                                    ? DateFormat.jm().format(DateFormat.Hm().parse(weatherController.timeConvert(timeStart).format(context)))
                                    : DateFormat.Hm().format(DateFormat.Hm().parse(weatherController.timeConvert(timeStart).format(context))),
                              ),
                              onPressed: () async {
                                final TimeOfDay? timeStartPicker = await showTimePicker(
                                  ...
                                  builder: (context, child) {
                                    final Widget mediaQueryWrapper = MediaQuery(
                                      data: MediaQuery.of(context).copyWith(alwaysUse24HourFormat: settings.timeformat == '12' ? false : true),
                                      child: child!,
                                    );
                            ...
                            SettingCard(
                              ...
                              infoWidget: _TextInfo(
                                info: settings.timeformat == '12'
                                    ? DateFormat.jm().format(DateFormat.Hm().parse(weatherController.timeConvert(timeEnd).format(context)))
                                    : DateFormat.Hm().format(DateFormat.Hm().parse(weatherController.timeConvert(timeEnd).format(context))),
                              ),
                              onPressed: () async {
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 15),
                              child: Text('data'.tr, style: context.textTheme.titleLarge?.copyWith(fontSize: 20)),
                            ),
                            SettingCard(
                              elevation: 4,
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 15),
                              child: Text('widget'.tr, style: context.textTheme.titleLarge?.copyWith(fontSize: 20)),
                            ),
                            SettingCard(
                              elevation: 4,
                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 15),
                                            child: Text('widgetBackground'.tr, style: context.textTheme.titleMedium?.copyWith(fontSize: 18)),
                                          ),
                                          Padding(
                            ...
                            SettingCard(
                              ...
                              infoWidget: CircleAvatar(
                                ...
                                radius: 11,
                                child: CircleAvatar(
                                  backgroundColor: widgetTextColor.isEmpty ? context.theme.primaryColor : HexColor.fromHex(widgetTextColor),
                                  radius: 10,
                                ),
                              ),
                              onPressed: () {
                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 15),
                                            child: Text('widgetText'.tr, style: context.textTheme.titleMedium?.copyWith(fontSize: 18)),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.symmetric(horizontal: 15),
                                            child: Theme(
                                              ...
                                              child: ColorPicker(
                                                pickerColor: widgetTextColor.isEmpty ? context.theme.primaryColor : HexColor.fromHex(widgetTextColor),
                                                onColorChanged: (pickedColor) {
          ...
          SettingCard(
            ...
            infoSettings: true,
            infoWidget: _TextInfo(
              info: appLanguages.firstWhere((element) => (element['locale'] == locale), orElse: () => appLanguages.first)['name'],
            ),
            onPressed: () {
              showModalBottomSheet(
                context: context,
                    ...
                    builder: (BuildContext context, setState) {
                      return ListView(
                        children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 15),
                            child: Text('language'.tr, style: context.textTheme.titleLarge?.copyWith(fontSize: 20), textAlign: TextAlign.center),
                          ),
                          ListView.builder(
                            shrinkWrap: true,
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 15),
                              child: Text('support'.tr, style: context.textTheme.titleLarge?.copyWith(fontSize: 20)),
                            ),
                            const SizedBox(height: 10),
                          ],
                        ),
          ...
          SettingCard(
            icon: Image.asset('assets/images/github.png', scale: 20),
            text: '${'project'.tr} GitHub',
            onPressed: () => urlLauncher('https://github.com/belinda-g-freitas/tiempo'),
          ),
          const SizedBox(height: 10),
        ],
      ),
...
class _TextInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Text(info, style: context.textTheme.bodyMedium, overflow: TextOverflow.visible),
    );
  }
}
